...
public class AboutAdapterInside extends RecyclerView.Adapter<AboutAdapterInside.VooHodel> {
    List<AboutBean.ResultBean> result;
    Context context;

    public AboutAdapterInside(List<AboutBean.ResultBean> result, Context context) {
        this.result = result;
    ...
    class VooHodel extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private SimpleDraweeView hot_simpleDraweeView;
