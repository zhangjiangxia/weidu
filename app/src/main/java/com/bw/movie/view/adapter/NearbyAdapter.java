...
public class NearbyAdapter extends RecyclerView.Adapter<NearbyAdapter.VooHodel>{
    List<NearbyBean.ResultBean.NearbyCinemaListBean> nearbyCinemaList;
    Context context;

    public NearbyAdapter(List<NearbyBean.ResultBean.NearbyCinemaListBean> nearbyCinemaList, Context context) {
