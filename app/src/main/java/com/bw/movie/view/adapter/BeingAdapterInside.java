...
public class BeingAdapterInside extends RecyclerView.Adapter<BeingAdapterInside.VooHodel> {
    Context  context;
    List<BeingBean.ResultBean> result;

    public BeingAdapterInside(Context context, List<BeingBean.ResultBean> result) {
